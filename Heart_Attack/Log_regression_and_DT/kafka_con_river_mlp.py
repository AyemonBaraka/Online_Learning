...
topic_name = "ha-river"  # Kafka topic for the training data
...
def process_message(key, value):
    ...
    # Convert all feature values to floats, handling conversion errors
    try:
    ...
    if count % 50 == 0 or count > 302:
        ...
        # Plot the results incrementally
        #plot_metrics()
...
try:
    ...
    while True:
        ...
        if time.time() - last_message_time >= timeout:
            print("No messages received for 1/2 minutes. Plotting final metrics and closing consumer.")
            plot_metrics()
    ...
    consumer.close()
    # Final plot if loop ends due to no messages or manual interruption
    print("Final plotting of metrics.")
    plot_metrics()
