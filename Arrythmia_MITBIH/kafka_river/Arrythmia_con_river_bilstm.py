...
class LSTMClassifier(nn.Module):
    def __init__(self, n_features, hidden_size1=100,hidden_size2=50, output_size = 2):
        ...
        self.rnn2 = nn.LSTM(
            input_size= 2*hidden_size1,
            hidden_size=self.hidden_size2,
            num_layers=1,
            batch_first=True,
            bidirectional = True
        )
        self.fc1 = nn.Linear(hidden_size2*2, 512)
...
model = compose.Pipeline(
    ...
    Classifier(module=LSTMClassifier, 
